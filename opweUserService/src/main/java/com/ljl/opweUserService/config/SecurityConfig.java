...
import com.ljl.opweUserService.filter.JwtAuthenticationFilter;
import com.ljl.opweUserService.handler.CustomAccessDeniedHandler;
...
@Configuration
@EnableWebSecurity
@EnableMethodSecurity(prePostEnabled = true, securedEnabled = true, jsr250Enabled = true) // Enable role-based annotations
